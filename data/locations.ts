...
export const locations0: StoryLocation[] = [
  {
    id:          1,
  ...
  },
  {
    ...
    subtitle:    "August 2016",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/kazakh_steppe_kazakhstan.jpg",
  ...
  },
  {
    ...
    description: "Gangai entered the Central Asian Flyway, an ancient migration corridor followed by generations of harriers. GPS studies suggest these routes remain remarkably consistent from year to year.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/tajikistan.jpg",
    lat:         39.89652,
    lng:         69.21604,
    zoom:        10,
    tilt:        48,
  ...
  },
  {
    ...
    description: "Gangai paused near the Amu Darya River, an important stopover where migrating harriers rest, hunt and replenish fat reserves before continuing their southward journey.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/amu_darya_river_banks.jpg",
    lat:         37.98254,
    lng:         68.76837,
    zoom:        11,
    tilt:        65,
  ...
  
  {
    ...
    description: "Gangai descended into the Indus River Basin, a natural migration corridor that funnels thousands of raptors from Central Asia into the Indian subcontinent every autumn.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/indus_river_basin_corridor.jpg",
    lat:         31.81119,
    lng:         68.63659,
    zoom:        7,
    tilt:        30,
  ...
  },
  {
    ...
    description: "Before heading further south, Gangai paused in the grasslands bordering the Thar Desert, where abundant grasshoppers and other insects allowed him to rebuild his energy reserves.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/thar_desert.jpg",
    lat:         30.07858,
    lng:         69.48732,
    zoom:        8,
    tilt:        35,
  ...
  },
  {
    ...
    description: "Tal Chhapar is one of India's most significant grassland habitats for migrating harriers. Hundreds of Montagu's and Pallid Harriers gather here during migration before dispersing across the country.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/tal_chhapar_grassland.jpg",
    lat:         28.00252,
    lng:         71.73281,
    zoom:        9,
    tilt:        35,
  ...
  },
  {
    ...
    description: "Gangai was captured here and fitted with a GPS transmitter. He returned to the same wintering site with remarkable precision year after year, demonstrating extraordinary site fidelity.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/maharashtra.jpg",
    lat:         19.10308,
    lng:         74.8038,
    zoom:        10,
    tilt:        42,
  ...
  },
  {
    ...
    description: "Each evening Gangai joined dozens of harriers at communal roosts hidden in tall grass. Researchers studied regurgitated pellets to understand their diet and monitor the health of the surrounding grassland ecosystem.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/motague_harrier.jpg",
    lat:         17.81148,
    lng:         76.04278,
    zoom:        11,
    tilt:        45,
...
export const locations: StoryLocation[] = [
  ...
  },
  {
    id:          2,
    title:       "Crossing the Kazakh Steppe, Kazakhstan",
    subtitle:    "https://atree-communication.s3.amazonaws.com/storymap-harrier/photo/Days/day3.png",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/kazakh_steppe_kazakhstan.jpg",
    description: "Leaving his natal grounds, Gangai crossed the vast Kazakh steppe, soaring on thermals above open grasslands that provided ideal hunting before the long journey across Central Asia.",
    lat:         44.944,
    lng:         75.347,
  ...
  },
  {
    id:          3,
    title:       "Tajikistan",
    subtitle:    "https://atree-communication.s3.amazonaws.com/storymap-harrier/photo/Days/day5.png",
    description: "Gangai entered the Central Asian Flyway, an ancient migration corridor followed by generations of harriers. GPS studies suggest these routes remain remarkably consistent from year to year.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/tajikistan.jpg",
    lat:         37.9912,
    lng:         68.7554,
  ...
  },
  {
    id:          4,
    title:       "Amu Darya River Banks, Uzbekistan",
    subtitle:    "https://atree-communication.s3.amazonaws.com/storymap-harrier/photo/Days/day7.png",
    description: "Gangai paused near the Amu Darya River, an important stopover where migrating harriers rest, hunt and replenish fat reserves before continuing their southward journey.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/amu_darya_river_banks.jpg",
    lat:         37.2419,
    lng:         69.4068,
  ...
  
  {
    id:          6,
    title:       "Indus River Basin Corridor, Pakistan",
    subtitle:    "https://atree-communication.s3.amazonaws.com/storymap-harrier/photo/Days/day10.png",
    description: "Gangai descended into the Indus River Basin, a natural migration corridor that funnels thousands of raptors from Central Asia into the Indian subcontinent every autumn.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/indus_river_basin_corridor.jpg",
    lat:         28.4444,
    lng:         69.7824,
  ...
  },
  {
    id:          7,
    title:       "Thar Desert Stopover, Rajasthan",
    subtitle:    "https://atree-communication.s3.amazonaws.com/storymap-harrier/photo/Days/day13.png",
    description: "Before heading further south, Gangai paused in the grasslands bordering the Thar Desert, where abundant grasshoppers and other insects allowed him to rebuild his energy reserves.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/thar_desert.jpg",
    lat:         26.981706,
    lng:         71.041345,
  ...
  },
  {
    id:          8,
    title:       "Tal Chhapar Grassland, Rajasthan",
    subtitle:    "https://atree-communication.s3.amazonaws.com/storymap-harrier/photo/Days/day19.png",
    description: "Tal Chhapar is one of India's most significant grassland habitats for migrating harriers. Hundreds of Montagu's and Pallid Harriers gather here during migration before dispersing across the country.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/tal_chhapar_grassland.jpg",
    lat:         25.4411,
    lng:         71.0599,
  ...
  },
  {
    id:          10,
    title:       "Gangewadi, Solapur, Maharashtra",
    subtitle:    "https://atree-communication.s3.amazonaws.com/storymap-harrier/photo/Days/day24.png",
    description: "Gangai was captured here and fitted with a GPS transmitter. He returned to the same wintering site with remarkable precision year after year, demonstrating extraordinary site fidelity.",
     img:"https://atree-communication.s3.ap-south-1.amazonaws.com/storymap-harrier/photo/arcgis/maharashtra.jpg",
    lat:        17.8248846,
    lng:         76.0120976,
