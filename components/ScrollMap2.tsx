...
export default function ScrollMap() {
  ...
  useEffect(() => {
    ...
    // can release and native scroll can continue past it. Without this,
    // scrolling down past the last location (or up before the first) gets
    // permanently swallowed and the page appears "stuck".
