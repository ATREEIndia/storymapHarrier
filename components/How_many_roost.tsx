        ...
        <Magazine_img_tsx
            ...
            content={
                <div>
                    ...
                    />
                    <p className='mt-3'>
                         Evenings during winter are balmy; the sky is lit and the grassland makes a wonderful scene, but for the harrier surveyor it is a case of jotting down as much information during a small window. It is a bit like taking attendance at school, checking how many harriers have turned up, each day, across the season. Keeping a count gives us an idea if their numbers are holding steady or slipping.<br /><br />
                         
                        Most evenings, we spend time scanning wide areas to map harrier movements and find their roosting place where harriers gather. Finding one is a roost would be very important; to find out it tells us which species visit our areas, what would be their maturity? What would be the male-female ratios, and their numbers each day and how would they change over months and seasons?
