...
export const responsive = "md:text-lg my-2 px-5 lg:px-10"
...
export const scroll_encounter = [
    ...
    },
    {
        content: (
            <div className="flex flex-col gap-5">
                <p className="text-gray-800 text-lg">
                    We were within a few 100 feet of the blaze. Around us, the rest of the birds scattered in every direction before settling down in another roost close by, a place where they gather to rest. <br /><br />
    ...
    },
    {
        content: (
            <div className="flex flex-col gap-5">
                <span className="text-gray-800 text-lg">
                    T. Ganesh's interest in Harriers goes back to the early 1990s when he started counting harrier roosts. One such was a roost on the outskirts of Hyderabad, which he studied for 7 years. <br /><br />

                    The study resumed in 2015, when Ganesh and his small team of researchers began tracking Montagu's harrier migration by fitting them with satellite tags at 6 sites.
...
export const scroll_day_researcher = [
    {
        content: (
            <div className="flex flex-col gap-5">
                <Title
                    topTitle=""
                    mainTitle="A day in the life of our team"
                />

                <p className="text-gray-800 text-lg">
                    In the winter months, we would set out at the crack of dawn, walking the trails looking out for harriers as they fly low, scanning for prey.
                </p>
            </div>
        ),
        media_type: "image",
    ...
    },
    {
        content: (
            <div className="flex flex-col gap-5">
                <p className="text-gray-800 text-lg">
                    Seeing a gliding, elegant blue-grey harrier was more refreshing to us than our morning cups of coffee. Imagine meeting a 4-month-old bird that had flown over the mountains and deserts to reach India!
                </p>
            </div>
        ),
        media_type: "image",
    ...
    = [
        ...
        },
        {
            content: (
                <div className="flex flex-col gap-5">
                    <span className="text-gray-800 text-lg">
                        <b>Stopover home:</b> As we traced each one of them through their autumn migration over the years, we realised how they stopped at the Thar Desert in India before reaching their destination. This helped us establish the importance of Thar Desert for these birds.
                        <br/><br/>
                        We found out they stopped over the desert not so much in pursuit of the migrating locusts but for the resident grasshoppers, which formed their main prey.
                        <br></br>
       ...
       
        {
            content: (
                <div className="flex flex-col gap-5">
                    <p className="text-gray-800 text-lg">
                        <b>Detour migration:</b> Another revelation was that migrating birds do not always take the shortest route between their breeding and wintering sites. Nine years of tracking showed us how the harriers took a detour of the Himalaya even if it meant more flying hours. 
