...
export const scroll_day_researcher = [
    {
        content: (
            <div className="flex flex-col gap-5">
                ...
                <p className="text-gray-800 text-lg">
                    In the winter months, we would set out at the crack of dawn, walking the trails looking out for harriers as they flew low, scanning for prey.
                </p>
            </div>
        ),
        media_type: "image",
...
export const finding_roost
    = [
        ...
        },
        {
            ...
            media_type: "image",
            caption: "These maps track the migration of individual harriers through the Thar Desert: (1) Dewani 2) Gangai 3) Hira 4) Mothiya, 5) Nellai 6) Paruthi 7) Poorni 8) Deo 9) Rupeli. Red dots indicate where each harrier was tagged.",
            media_src:
